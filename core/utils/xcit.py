...
"""
from core.utils.helpers  import to_2tuple
...
class XCA_separate(nn.Module):
    ...
    def forward(self, x_qk, x_v):  # 这他妈不对劲啊，这个注意力还是x_qk给的，但是乘到v上面了
        B, N, C = x_qk.shape
...
class XCiT(nn.Module):
    ...
    def __init__(self, embed_dim=128,
                 ...
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0.05, norm_layer=None, use_pos=True, eta=1.0,
                 separate=False):
        """
        Args:
    ...
    def forward(self, x, x_v=None):
        ...
        if self.separate:  # separate应该是交叉注意力
